...
# SCRIPT: Storing the results for RACE_COLOR White
  ...
  LT_Male_White <- LT(BHlifetable_data_TWO, "Male", "White")
  
  LT_Female_White <- LT(BHlifetable_data_TWO, "Female", "White")

# ---
# Storing the results for RACE_COLOR Mixed_Black

  LT_Male_Mixed_Black <- LT(BHlifetable_data_TWO, "Male", "Mixed_Black")
  
  LT_Female_Mixed_Black <- LT(BHlifetable_data_TWO, "Female", "Mixed_Black")
